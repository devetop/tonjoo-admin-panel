...
(function ($) {
  ...
  $container.append(
    '<h5>Demo Options</h5><hr class="mb-2"/>'
  )

  //Amanah Skins Options
  var amanah_skins = [
    'skin-backend-1', // 'Backend 1 - Semi Dark',
    'skin-backend-2', // 'Backend 2 - Light',
    'skin-backend-3', // 'Backend 3 - Light',
    'skin-backend-4', // 'Backend 4 - Semi Dark',
    'skin-backend-5', // 'Backend 5 - Semi Dark',
    'skin-backend-6', // 'Backend 6 - Full Dark',
    'skin-frontend-1', // 'Frontend 1 - Semi Dark',
    'skin-frontend-2', // 'Frontend 2 - Semi Dark',
    'skin-frontend-3', // 'Frontend 3 - Light',
    'skin-frontend-4', // 'Frontend 4 - Light',
    'skin-frontend-5', // 'Frontend 5 - Light',
  ]

  //Amanah Color Skins
  $container.append('<h6>Amanah Skins ( Body Class )</h6>')

  var $amanah_skins = $('<div />', {
    class: 'd-flex'
  })

  $container.append($amanah_skins)
  $container.append(createSkinBlock(amanah_skins, function () {
    var color = $(this).find('option:selected').attr('class')
    var $body = $('body')
    amanah_skins.forEach(function (skin) {
      $body.removeClass(skin)
    })

    var amanah_skin_class = color.replace('bg-', 'accent-')

    $body.addClass(amanah_skin_class)

    document.cookie = 'skin='+ amanah_skin_class +';';

    if ( getCookie('skin') == 'skin-backend-2' || getCookie('skin') == 'skin-backend-3' || getCookie('skin') == 'skin-frontend-5' ) {
      document.cookie = 'sidebarColor=sidebar-light-primary;';
      if ( $('.main-sidebar').hasClass('sidebar-dark-primary') ) {
        $('.main-sidebar').removeClass('sidebar-dark-primary')
        $('.main-sidebar').addClass('sidebar-light-primary')
      }

    }else{
      document.cookie = 'sidebarColor=sidebar-dark-primary;';
      if ( $('.main-sidebar').hasClass('sidebar-light-primary') ) {
  ...
  var active_amanah_skin = null
  $('body')[0].classList.forEach(function (className) {
    if (amanah_skins.indexOf(className) > -1 && active_amanah_skin === null) {
      active_amanah_skin = className.replace('navbar-', 'bg-')
      $('select.custom-select').find('.' + active_amanah_skin).prop("selected", true);
    }
  })
  ...
  //Layout Boxed
  var $layout_boxed_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    ...
    if ($(this).is(':checked')) {
      ...
      document.cookie = 'boxed=layout-boxed;';

    } else {
      $('body').removeClass('layout-boxed')
      document.cookie = 'boxed=;';
    }
  })
  ...
  var $layout_boxed_container = $('<div />', { class: 'mb-4' }).append($layout_boxed_checkbox).append('<span>Layout Boxed</span>')
  $container.append($layout_boxed_container)
