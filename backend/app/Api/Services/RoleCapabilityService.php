...
//TODO refactor
//extract DTO's
class RoleCapabilityService implements RoleCapabilityInterface
{
    private $configRepo;
    ...
    public function addWithContext($context, $name, $id = false, $parent = false, $callback = null)
    {
        ...
        $capabilities = $this->configRepo->get("cms.user.capabilities.$context", []);
        ...
        $this->configRepo->set("cms.user.capabilities.$context", $capabilities);
    ...
    public function getWithContext($context, $id)
    {
        $capability = $this->arrayHelper->searchValueRecursive($id,
            $this->configRepo->get("cms.user.capabilities.$context", []));
