...
class ProductController extends Controller
{
    ...
    {
        context_authorize('dashboard', ['product-can-show-all' => [$id]]);
    ...
    {
        context_authorize('dashboard', ['product-can-update-all' => [$id]]);
    ...
    {
        context_authorize('dashboard', ['product-can-delete-all' => [$id]]);
