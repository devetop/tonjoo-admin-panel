...
class ProductController extends Controller
{
    ...
    {
        context_authorize('dashboard', 'product-can-view-all');
    ...
    {
        context_authorize('dashboard', 'product-can-create');
    ...
    {
        context_authorize('dashboard', 'product-can-show-all');
    ...
    {  
        context_authorize('dashboard', 'product-can-update-all');
    ...
    {
        context_authorize('dashboard', 'product-can-delete-all');
    ...
    {
        return response()->json([
            'data' => app(User::class)->pluck('users.name', 'users.id')
        ]);
    }
}
