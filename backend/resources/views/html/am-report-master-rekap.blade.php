                ...
                <div class="card">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="am-report-master-rekap.php" role="tab" aria-selected="true">Rekap</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="am-report-master-detail.php" aria-selected="false">Detail</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <table cellspacing="0" class="table table-compact table-head-fixed table-bordered table-head-nowrap table-striped table-main" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sort"><a href="#">Total Jam Kerja <i class="ph ph-sort-descending"></i></a></th>
                                        <th class="col-sort"><a href="#">+/- Jam Kerja <i class="ph ph-sort-descending"></i></a></th>
                                        <th>Hari Kerja</th>
                                        <th>Hari Masuk</th>  
                                        <th>Unpaid Leave</th>
                                        <th>Paid Leave</th>
                                        <th class="col-sort"><a href="#">Rata-rata <i class="ph ph-sort-descending"></i></a></th>                    
                                        <th width="100" class="text-center">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php for ($i=0; $i<5; $i++) { ?>
                                        <tr style="background: #d0eee0; color: #53856c;">
                                            <td>Halim Kurniawan Wibowo</td>
                                            <td>16:35</td>
                                            <td>+00:35</td>
                                            <td>2</td>
                                            <td>2</td>
                                            ...
                                            <td>08:17</td>
                                            <td>
                                            <a class="btn btn-xs btn-link" href="#" style="margin-right: 1px;"><i class="ph ph-magnifying-glass"></i></a>
                                            <a class="btn btn-xs btn-link" href="#" style="margin-right: 1px;"><i class="ph ph-note"></i></a>
                                            </td>
                                        </tr>
                                        <tr style="background: #faebd7; color: #d99667;">
                                        ...
                                        <tr style="background: #ffd5d0; color: #e8596c;">
                                            <td>Ahmad Muzakki</td>
                                            <td>15:56</td>
                                            <td>-00:4</td>
                                            <td>2</td>
