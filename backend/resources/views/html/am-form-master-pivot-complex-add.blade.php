    ...
    <section class="content">
        <div class="container-fluid">
            <div class="mw-1200px">
                ...
                <form accept-charset="UTF-8" id="mainForm" action="" method="post" role="form" class="multi-action-form validate-form"> 
                    <div class="row">
                        <div class="col-12 col-lg">
                            <div class="card">
                                                ...
                                                <div class="col-12 col-md-10 col-lg-8">
                                                    <div class="d-flex align-items-start">
                                                        <div class="input-wrap w-100">
                                                            <select style="width: 100%;" class="form-control js-select2-pegawai" name="pegawai" 
                                ...
                                data-placeholder="Pilih Nama Pegawai">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12 col-md-2 col-lg-4">
                                                    <label class="control-label text-right font-weight-normal d-flex justify-content-end align-items-center">Username</label>
                                                </div>
                                                <div class="col-12 col-md-10 col-lg-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="btn-group w-100">
                                                        <button class="btn btn-sm btn-primary btn-block js-submit-create" type="button">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
  $(function () {
    ...
    $('#mainForm [name="pegawai"]').on('change', populateDataPegawai);

    // populateDataPegawai( $('#mainForm [name="pegawai"]') )
    ...
    $('.js-submit-create').on('click', function(){
      $('form').attr('action', '{{@url("/html/am-form-master-pivot-complex-edit?success&kontrak=0&pegawai=")}}' + $('form').find('[name=pegawai]').val() );
      setCookie('kontrak','0','1');
      $('form').submit();
    })
