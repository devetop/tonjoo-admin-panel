                                                        ...
                                                        <div class="variant-card__body">
                                                            <div class="form-horizontal p-2">
                                                                <div class="form-group form-group--view row">
                                                                    ...
                                                                    <div class="col-12 col-lg-8">
                                                                        <div class="form-value">Rp50.000,00</div>
                                                                    </div>
                                                                    </div>
                                                                    <!-- /.form-group -->

                                                                    <div class="form-group form-group--view row">
                                                                    <label class="col-12 col-lg-4 label-inline">Category</label>

                                                                    <div class="col-12 col-lg-8">
                                                                        <div class="form-value">Category A</div>
                                                                    </div>
                                                                    </div>
                                                                    <!-- /.form-group -->

                                                                    <div class="form-group form-group--view row">
                                                                    <label class="col-12 col-lg-4 label-inline">Attributes</label>
                                                    ...
                                                    <div class="variant-card__footer border-none">
                                                        <div class="btn-card-wrapper">
                                                            <div class="row no-gutters">
                                                                <div class="col-md-4">
                                                                    <a href="#" class="btn btn-card"><i class="ph ph-trash"></i> Delete</a>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <a href="#" class="btn btn-card"><i class="ph ph-eye"></i> View</a>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <a href="#" class="btn btn-card"><i class="ph ph-pencil"></i> Edit</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
