...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src={{@url("assets/backend/dist/img/user2-160x160.jpg")}} class="user-image img-circle elevation-2" alt="User Image">
          <span class="d-none d-md-inline">Alexander Pierce</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src={{@url("assets/backend/dist/img/user2-160x160.jpg")}} class="img-circle elevation-2" alt="User Image">
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body"> Check the Header part you can find Legacy vesion of style. <br> Start creating your amazing application! </div>
            <!-- /.card-body -->
