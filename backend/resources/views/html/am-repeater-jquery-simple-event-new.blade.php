<?php 
$pageTitle = 'Repeater Simple Event';
$breadcrumbs = array( 
    ['Home', '#'],
    [ $pageTitle, '#']
);
                                ...
                                <div class="card shadow-none border">
                                    ...
                                    <div class="card-body px-2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9 col-md-10">
                                                <div class="input-wrap">
                                                    <input class="form-control form-control-sm" name="nama" type="text" placeholder="Nama" required data-parsley-required-message="Nama wajib diisi">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9 col-md-10">
                                                <div class="input-wrap">
                                                    <input class="form-control form-control-sm" name="phone" type="text" placeholder="Telepon">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            <div class="col-md-10">
                                                                                                                <div class="form-group row">
                                                                                                                    ...
                                                                                                                    <div class="col-xs-9 col-md-10">
                                                                                                                        <div class="input-wrap">
                                                                                                                            <input type="text" class="form-control form-control-sm" name="barang" placeholder="Barang" value="" required data-parsley-required-message="Nama Barang wajib diisi">
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group row">
                                                                                                                    ...
                                                                                                                    <div class="col-xs-9 col-md-10">
                                                                                                                        <div class="input-wrap">
                                                                                                                            <input type="number" class="form-control form-control-sm" name="jumlah" placeholder="Jumlah" value="" required data-parsley-required-message="Nama wajib diisi">
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
