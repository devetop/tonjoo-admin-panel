    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <?php } ?>
                ...
                <form id="mainForm" accept-charset="UTF-8" action="am-form-master-pivot-complex-view?success" method="post" role="form" class="multi-action-form validate-form"> 
                    @csrf
                    <div class="row">
                                ...
                                <div class="card-header py-2">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <a href="am-form-master-pivot-complex-add-data<?php echo (!empty($_POST['pegawai']) && $_POST['pegawai'] != '') ? '?pegawai=' . $_POST['pegawai'] : '' ;?>" class="btn btn-sm btn-default" data-repeater-create>
                                            ...
                                            <div class="card shadow-none border">
                                                <div class="card-body p-2">
                                                    <div class="text-right mb-10">
                                                        <a href="am-form-master-pivot-complex-add-data?edit" class="btn btn-default ml-auto"><i class="ph ph-pencil mr-1"></i> Edit</a>
                                                    </div>
