              ...
              <div class="col-12">
                  ...
                  <div class="invoice p-3 mb-3">
                      ...
                      <div class="row">
                          <div class="col-12">
                              <h4>
                                  <i class="fas fa-globe"></i> AdminLTE, Inc. <small class="float-right">Date: 2/10/2014</small>
                              </h4>
                          </div>
                          <!-- /.col -->
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-6">
                              ...
                              <img src="<?php echo $assetPath; ?>assets/backend/dist/img/credit/visa.png" alt="Visa">
                              <img src="<?php echo $assetPath; ?>assets/backend/dist/img/credit/mastercard.png" alt="Mastercard">
                              <img src="<?php echo $assetPath; ?>assets/backend/dist/img/credit/american-express.png" alt="American Express">
                              <img src="<?php echo $assetPath; ?>assets/backend/dist/img/credit/paypal2.png" alt="Paypal">
                              <p class="text-muted well well-sm shadow-none" style="margin-top: 10px;"> Etsy doostang zoodles disqus groupon greplin oooj voxy zoodles, weebly ning heekya handango imeem plugg dopplr jibjab, movity jajah plickers sifteo edmodo ifttt zimbra. </p>
                          </div>
                          <!-- /.col -->
                          <div class="col-6">
                      ...
                      <div class="row no-print">
                          <div class="col-12">
                              <a href={{@url("html.lte-example-page-invoice__print.php")}} rel="noopener" target="_blank" class="btn btn-default">
