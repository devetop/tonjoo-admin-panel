    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <!-- /.social-auth-links -->
                <p class="mb-1">
                    <a href={{@url("html.lte-example-extra-forgot-password-v2.php")}}>I forgot my password</a>
                </p>
                <p class="mb-0">
                    <a href={{@url("html.lte-example-extra-register-v2.php")}} class="text-center">Register a new membership</a>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
