...
<link rel="stylesheet" src={{@url("assets/backend/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css")}}>
<!-- iCheck -->
<link rel="stylesheet" src={{@url("assets/backend/plugins/icheck-bootstrap/icheck-bootstrap.min.css")}}>
<!-- JQVMap -->
<link rel="stylesheet" src={{@url("assets/backend/plugins/jqvmap/jqvmap.min.css")}}>
<!-- Daterange picker -->
<link rel="stylesheet" src={{@url("assets/backend/plugins/daterangepicker/daterangepicker.css")}}>
<!-- summernote -->
<link rel="stylesheet" src={{@url("assets/backend/plugins/summernote/summernote-bs4.min.css")}}>
