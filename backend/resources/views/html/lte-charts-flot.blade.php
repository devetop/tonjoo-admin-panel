				...
				<div class="col-12">
					...
					<div class="card card-primary card-outline">
						<div class="card-header">
							...
							<div class="card-tools"> Real time <div class="btn-group" id="realtime" data-toggle="btn-toggle">
...
<!-- FLOT CHARTS -->
<script src={{url("dist/plugins/flot/jquery.flot.js")}}></script>
<!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
<script src={{url("dist/plugins/flot/plugins/jquery.flot.resize.js")}}></script>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<script src={{url("dist/plugins/flot/plugins/jquery.flot.pie.js")}}></script>
