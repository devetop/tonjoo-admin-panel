<?php 
$pageTitle = 'Table Sample Alternatif';
$breadcrumbs = array( 
    ['Home', '#'],
    [ $pageTitle, '#']
);
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error atque explicabo asperiores pariatur ex commodi molestiae quas in delectus officiis dolores nihil dolorem consequuntur accusantium voluptatum, quibusdam blanditiis facilis esse ullam veniam, placeat consectetur ut facere. Eveniet aspernatur delectus perspiciatis.</p>

                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa possimus saepe, maiores a suscipit unde.</p>
                        ...
                        <div class="col-sm-12 col-md-8">
                            <div class="row row-action separator justify-content-end align-items-center">
                                <div class="col-auto column-button">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default btn-sm dropdown-toggle export-btn custom-icon" data-toggle="dropdown">
                                    ...
                                    <!-- forward button -->
                                    <a href="#" class="btn btn-default btn-sm"><i class="ph ph-share mr-1"></i> Forward</a>

                                    <!-- print button -->
                                    <a href="#" class="btn btn-default btn-sm"><i class="ph ph-printer mr-1"></i> Print</a>

                                    <!-- share button -->
                                    <a href="#" class="btn btn-default btn-sm"><i class="ph ph-share-network mr-1"></i> Share</a>
                                </div>
                    ...
                    <div class="table-action-top no-gap">
                        <div class="row align-items-center flex-wrap">
                            <div class="col-auto d-flex align-items-center">
                                ...
                                <div class="action bulk-action d-flex align-items-center mr-2 pr-2 border-right">
                                ...
                                <div class="action filter-action d-flex align-items-center">
                                    ...
                                    <button class="btn btn-default btn-sm ml-2">Filter</button>
                                </div>  
                            </div>
