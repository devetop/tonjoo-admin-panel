                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9 col-md-10">
                                            <div class="input-wrap">
                                                <input class="form-control form-control-sm" name="monitor_name" type="text" data-rule-required="true" data-msg-required="Monitor name field is required." placeholder="Input Monitor Name" value="<?php echo (isset($_GET['add'])) ? '' : 'demo.tonjoostudio.com' ;?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9 col-md-10">
                                            <div class="input-wrap">
                                                <input class="form-control form-control-sm" name="monitor_url" type="text" data-rule-required="true" data-msg-required="URL field is required." placeholder="Input URL" value="<?php echo (isset($_GET['add'])) ? '' : 'http://demo.tonjoostudio.com' ;?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.form-group -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9 col-md-10">
                                            <div class="input-wrap">
                                                ...
                                                ?>   
                                                <select style="width: 100%;" disabled class="form-control form-control-sm js-select2" name="group" 
                                    ...
                                    <div class="card-footer">
                                        <div class="submit-row">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <a href={{@url("/html/am-form-master-basic-edit")}} class="btn btn-sm btn-primary d-block w-full">Edit</a>
...
<script>
    $(function () {
        ...
        $('.js-submit-create').on('click', function(){
            $('form').attr('action', 'am-form-master-basic-view.php?success');
            $('form').submit();
        })
