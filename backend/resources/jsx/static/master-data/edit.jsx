...
function MasterDataEdit() {
    return <MasterDataForm defaultData={_defaultData} />
}
...
export default (props) => {
    ...
    useEffect(() => {
        dispatch(setBreadcrumbs([['Master Data', '/jsx/master-data'], ['Edit', '/jsx/master-data/edit']]));
    }, [])
    ...
    return (
        ...
        >
            <TapHead title="Edit Master Data" />
            <MasterDataEdit {...props} />
        </ContentLayout>
    )
}